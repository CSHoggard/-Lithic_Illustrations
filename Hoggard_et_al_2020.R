...
shapiro.test(metric_data_handaxe$Width_mm[41:53]) ### non-normal result 
...
adonis(cbind(Length_mm, Width_mm) ~ Class, data = metric_data_handaxe[37:54,])  ### non-parametric manova (3rd artefact)
